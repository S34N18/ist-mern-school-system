...
exports.getClassroomStudents = async (req, res) => {
  try {
    ...
    //         Lecturers see their created assignments.

    //         Students see assignments for their enrolled classes.

    // GET /assignments/student/:studentId

    //     Returns assignments relevant to a specific student.

    //     Useful for features like calendar or dashboard views.
    ...
    //     Requires lecturer authentication.

    //     Accepts assignment details and optional file upload.

    // PUT /assignments/:id

    //     Updates an existing assignment.

    //     Only the creator (lecturer) can edit.

    //     File can be replaced if needed.

    // DELETE /assignments/:id

    //     Deletes an assignment by ID.

    //     Also deletes associated uploaded file from the server.

    // GET /assignments/file/:filename

    //     Downloads an uploaded assignment file by its filename.
