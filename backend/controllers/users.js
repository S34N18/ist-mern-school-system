...
// ✅ User Endpoints and Functionalities
// 1. GET /api/users

//     Admin: View all users.

//     Lecturer: View only their students.
...
//     Lecturer: View a student only if assigned to one of their classrooms.
...
//         Can create users of any role: student, lecturer, admin.

//         Validates unique email and studentId for students.

// 4. PUT /api/users/:id

//     Admin: Update any user's details.

//     Lecturer: Update their own profile only.

//     Student: Update their own profile only.

//         Cannot update role or studentId.
...
//         Cannot delete lecturers who are assigned to classrooms (to avoid orphaned data).
